...
class TestBookingIntegrationTest(unittest.TestCase):
    ...
    def test_EC020_book_one_flight(self):
        testInfo = TestInfo("EC20", "Test Book One Flight")
    ...
    def test_EC021_book_two_flights(self):
        testInfo = TestInfo("EC21", "Test Book Two Flights")
    ...
    def test_EC022_test_remove_one_booking(self):
        testInfo = TestInfo("EC22", "Test Remove booked flight")
    ...
    def test_EC023_test_remove_one_booking(self):
        testInfo = TestInfo("EC23", "Test Remove all booked flights")
