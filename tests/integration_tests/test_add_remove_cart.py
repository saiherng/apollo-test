...
class TestAddRemoveCartIntegrationTest(unittest.TestCase):
    ...
    def test_EC022_add_to_cart(self):
        testInfo = TestInfo("EC22", "Test Add To Cart Button Action")
    ...
    def test_EC023_remove_from_cart(self):
        testInfo = TestInfo("EC23", "Test Remove From Cart Button Action")
