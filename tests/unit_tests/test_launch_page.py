...
class TestLauchPageUnitTest(unittest.TestCase):
    ...
    def test_EC008_page_content(self):
        testInfo = TestInfo("EC8", "Test that the page content loaded")
    ...
    def test_EC009_button_texts(self):
        testInfo = TestInfo("EC9", "Test Add To Cart Button Texts")
